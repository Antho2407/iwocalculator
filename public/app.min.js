!(function (e) {
      ...
      e.exports = (function () {
          ...
          for (n in t)
            c(t, n) &&
              (s(e[n]) && s(t[n])
                ...
                ? (a[n] = t[n])
                : delete a[n]);
          for (n in e) c(e, n) && !c(t, n) && s(e[n]) && (a[n] = _({}, a[n]));
          return a;
        }
        function E(e) {
          null != e && this.set(e);
        ...
        function $(e, t) {
          ...
          for (R.lastIndex = 0; n >= 0 && R.test(e); )
            (e = e.replace(R, a)), (R.lastIndex = 0), (n -= 1);
          return e;
        }
        var G = /\d/,
          B = /\d\d/,
        ...
        J("Y", 0, 0, function () {
          ...
          fe("YYYY", function (e, t) {
            t[ye] = 2 === e.length ? r.parseTwoDigitYear(e) : v(e);
          }),
          fe("YY", function (e, t) {
        ...
        (Se = Array.prototype.indexOf
          ...
          fe(["MMM", "MMMM"], function (e, t, n, a) {
            ...
            null != r ? (t[Me] = r) : (f(n).invalidMonth = e);
          });
        var Oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        ...
        function Ve(e, t, n) {
          ...
          return (
            s < 1
              ? ((r = e.year() - 1), (a = s + $e(r, t, n)))
              : s > $e(e.year(), t, n)
              ? ((a = s - $e(e.year(), t, n)), (r = e.year() + 1))
              : ((r = e.year()), (a = s)),
            { week: a, year: r }
          );
        }
        ...
        function et() {
          ...
          for (s.sort(e), o.sort(e), u.sort(e), l.sort(e), t = 0; t < 7; t++)
            (o[t] = _e(o[t])), (u[t] = _e(u[t])), (l[t] = _e(l[t]));
        ...
        J("H", ["HH", 2], 0, "hour"),
          ...
          fe("Hmm", function (e, t, n) {
            var a = e.length - 2;
            (t[ge] = v(e.substr(0, a))), (t[Ye] = v(e.substr(a)));
          }),
          fe("Hmmss", function (e, t, n) {
            var a = e.length - 4,
              r = e.length - 2;
          ...
          return (function (e) {
            for (var t, n, a, r, i = 0; i < e.length; ) {
              for (
                ...
                if ((a = dt(r.slice(0, t).join("-")))) return a;
          ...
          if (!e._d) {
            for (
              a = (function (e) {
                ...
                e._w &&
                  ...
                  (function (e) {
                    ...
                    if (null != (t = e._w).GG || null != t.W || null != t.E)
                      (i = 1),
                        (s = 4),
                        (n = ht(t.GG, e._a[ye], Ve(jt(), 1, 4).year)),
                        (a = ht(t.W, 1)),
                        ((r = ht(t.E, 1)) < 1 || r > 7) && (u = !0);
                    else {
                ...
                null != e._dayOfYear &&
                  ((s = ht(e._a[ye], a[ye])),
                  (e._dayOfYear > Te(s) || 0 === e._dayOfYear) &&
        ...
        function Ot(e, t) {
          var n, a;
          if ((1 === t.length && i(t[0]) && (t = t[0]), !t.length)) return jt();
        ...
        function At(e) {
          ...
          (this._isValid = (function (e) {
            ...
            for (var n = !1, a = 0; a < Ct.length; ++a)
              if (e[Ct[a]]) {
                if (n) return !1;
                parseFloat(e[Ct[a]]) !== v(e[Ct[a]]) && (n = !0);
              }
            return !0;
          })(t)),
        ...
        function It(e, t) {
          ...
          return t._isUTC
            ? ((n = t.clone()),
              (a =
                (Y(e) || l(e) ? e.valueOf() : jt(e).valueOf()) - n.valueOf()),
                ...
                (r =
                  i.isValid() && s.isValid()
                    ? ((s = It(s, i)),
                      i.isBefore(s)
                        ? (o = Qt(i, s))
                        : (((o = Qt(s, i)).milliseconds = -o.milliseconds),
                          (o.months = -o.months)),
                      o)
          ...
          return function (n, a) {
            ...
            return (
              null === a ||
                ...
                (n = a),
                (a = r)),
              qt(this, Gt((n = "string" == typeof n ? +n : n), a), e),
              this
            );
          };
        }
        function qt(e, t, n, a) {
          ...
          e.isValid() &&
            ((a = null == a || a),
            o && We(e, je(e, "Month") + o * n),
            s && Ee(e, "Date", je(e, "Date") + s * n),
        ...
        (gn.add = Zt),
          (gn.calendar = function (e, t) {
            ...
            return this.format(s || this.localeData().calendar(i, this, jt(n)));
          }),
          (gn.clone = function () {
            return new g(this);
          }),
          (gn.diff = function (e, t, n) {
            ...
            switch (
              ((r = 6e4 * (a.utcOffset() - this.utcOffset())), (t = C(t)))
            ) {
              case "year":
                i = en(this, a) / 12;
                break;
            ...
            switch (e) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t +=
                    on -
                    ln(t + (this._isUTC ? 0 : this.utcOffset() * sn), on) -
                    1);
                break;
              case "minute":
          ...
          (gn.from = function (e, t) {
            return this.isValid() && ((Y(e) && e.isValid()) || jt(e).isValid())
          ...
          (gn.startOf = function (e) {
            ...
            switch (e) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t -= ln(t + (this._isUTC ? 0 : this.utcOffset() * sn), on));
                break;
              case "minute":
          ...
          (gn.utcOffset = function (e, t, n) {
            ...
            if (null != e) {
              ...
              return (
                !this._isUTC && t && (a = Ut(this)),
                (this._offset = e),
                (this._isUTC = !0),
                null != a && this.add(a, "m"),
                i !== e &&
                  (!t || this._changeInProgress
                    ? qt(this, Gt(e - i, "m"), 1, !1)
          ...
          (gn.dates = T("dates accessor is deprecated. Use date instead.", fn)),
          (gn.months = T(
            "months accessor is deprecated. Use month instead",
            Fe
          )),
          (gn.years = T("years accessor is deprecated. Use year instead", xe)),
          (gn.zone = T(
        ...
        function wn(e, t, n, a) {
          ...
          var r,
            i = mt(),
            s = e ? i._week.dow : 0;
          if (null != n) return vn(t, (n + s) % 7, a, "day");
          var o = [];
          for (r = 0; r < 7; r++) o[r] = vn(t, (r + s) % 7, a, "day");
          return o;
        }
          ...
          (kn.monthsParse = function (e, t, n) {
            ...
            if (this._monthsParseExact)
              return function (e, t, n) {
                ...
                return n
                  ? "MMM" === t
                    ? -1 !== (r = Se.call(this._shortMonthsParse, s))
                      ? r
                      : null
                    : -1 !== (r = Se.call(this._longMonthsParse, s))
                    ? r
                    : null
                  : "MMM" === t
                  ? -1 !== (r = Se.call(this._shortMonthsParse, s))
          ...
          (kn.weekdaysParse = function (e, t, n) {
            ...
            if (this._weekdaysParseExact)
              return function (e, t, n) {
                ...
                return n
                  ? "dddd" === t
                    ? -1 !== (r = Se.call(this._weekdaysParse, s))
                      ? r
                      : null
                    : "ddd" === t
                    ? -1 !== (r = Se.call(this._shortWeekdaysParse, s))
                      ? r
                      : null
                    : -1 !== (r = Se.call(this._minWeekdaysParse, s))
                    ? r
                    : null
                  : "dddd" === t
                  ? -1 !== (r = Se.call(this._weekdaysParse, s))
        ...
        function Xn() {
          ...
          if (!c) return "P0D";
          var _ = c < 0 ? "-" : "",
            m = Zn(this._months) !== Zn(c) ? "-" : "",
            f = Zn(this._days) !== Zn(c) ? "-" : "",
            h = Zn(this._milliseconds) !== Zn(c) ? "-" : "";
          return (
            _ +
            "P" +
            (i ? m + i + "Y" : "") +
        ...
        return (
          ...
          (ea.as = function (e) {
            ...
            if ("month" === (e = C(e)) || "quarter" === e || "year" === e)
              switch (
                ((t = this._days + a / 864e5), (n = this._months + xn(t)), e)
              ) {
                case "month":
                  return n;
                case "quarter":
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      var T = function (e) {
          var t = document.head,
            ...
            r = (function (e) {
              for (var t = e.childNodes, n = t.length; n >= 0; n--) {
                var a = t[n];
                if (a && 1 === a.nodeType && a.hasAttribute(L)) return a;
              }
            })(n),
            i = void 0 !== r ? r.nextSibling : null;
          a.setAttribute(L, "active"), a.setAttribute(g, Y);
          var s = b();
          return s && a.setAttribute("nonce", s), n.insertBefore(a, i), a;
        },
        D = function (e) {
          if (e.sheet) return e.sheet;
          for (var t = document.styleSheets, n = 0, a = t.length; n < a; n++) {
            var r = t[n];
            ...
            (t.insertRule = function (e, t) {
              if (e <= this.length && e >= 0) {
                var n = document.createTextNode(t),
                  a = this.nodes[e];
                return (
                  this.element.insertBefore(n, a || null), this.length++, !0
                );
              }
              return !1;
            }),
          ...
          return (
            ...
            (t.insertRules = function (e, t) {
              if (e >= this.groupSizes.length) {
                for (var n = this.groupSizes, a = n.length, r = a; e >= r; )
                  (r <<= 1) < 0 && w(16, "" + e);
                (this.groupSizes = new Uint32Array(r)),
                  this.groupSizes.set(n),
                  (this.length = r);
                for (var i = a; i < r; i++) this.groupSizes[i] = 0;
              }
              for (
                var s = this.indexOfGroup(e + 1), o = 0, u = t.length;
                o < u;
                o++
              )
            ...
            (t.clearGroup = function (e) {
              if (e < this.length) {
                var t = this.groupSizes[e],
                  ...
                  a = n + t;
                this.groupSizes[e] = 0;
                for (var r = n; r < a; r++) this.tag.deleteRule(n);
              }
            }),
        ...
        F = function (e, t) {
          t >= C && (C = t + 1), P.set(e, t), O.set(t, e);
        },
        z = "style[" + L + "][" + g + '="' + Y + '"]',
        N = /(?:\s*)?(.*?){((?:{[^}]*}|(?!{).*?)*)}/g,
        R = new RegExp("^" + L + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\]'),
        I = function (e, t, n) {
          for (var a, r = n.split(","), i = 0, s = r.length; i < s; i++)
            (a = r[i]) && e.registerName(t, a);
        },
        U = function (e, t) {
          for (var n, a = t.innerHTML, r = []; (n = N.exec(a)); ) {
            var i = n[1].match(R);
            if (i) {
              ...
              0 !== s &&
                ...
                (r.length = 0);
            } else r.push(n[0].trim());
          }
        },
        J = function (e) {
          for (
            var t = document.querySelectorAll(z), n = 0, a = t.length;
            n < a;
            n++
          ) {
            var r = t[n];
            r &&
              "active" !== r.getAttribute(L) &&
              (U(e, r), r.parentNode && r.parentNode.removeChild(r));
          }
        },
        V = k,
        $ = { isServer: !k, useCSSOMInjection: !v },
        G = (function () {
          function e(e, t, n) {
            void 0 === e && (e = $),
              void 0 === t && (t = {}),
              ...
              !this.options.isServer && k && V && ((V = !1), J(this));
          }
          ...
          return (
            ...
            (t.toString = function () {
              return (function (e) {
                for (
                  var t = e.getTag(), n = t.length, a = "", r = 0;
                  r < n;
                  r++
                ) {
                  var i = W(r);
      ...
      function Z(e) {
        var t,
          ...
          _ = (function (e) {
            ...
            return function (n, a, r, i, s, o, u, l, d, c) {
              switch (n) {
                case 1:
          ...
          m = function (e, a, r) {
            return a > 0 &&
              -1 !== r.slice(0, a).indexOf(n) &&
              r.slice(a - n.length, a) !== n
              ? "." + t
              : e;
          };
        function p(e, r, i, s) {
      ...
      var X = i.a.createContext(),
        ee = (X.Consumer, i.a.createContext()),
        te = (ee.Consumer, new G()),
        ne = Z();
      function ae() {
        return Object(r.useContext)(X) || te;
      }
      function re() {
        return Object(r.useContext)(ee) || ne;
      }
      var ie = (function () {
          function e(e, t) {
            var n = this;
            (this.inject = function (e) {
              e.hasNameForId(n.id, n.name) ||
                e.insertRules(n.id, n.name, ne.apply(void 0, n.stringifyArgs));
            }),
        ...
        oe = /^ms-/;
      function ue(e) {
        return e.replace(se, "-$1").toLowerCase().replace(oe, "-ms-");
      }
      var le = function (e) {
          return null == e || !1 === e || "" === e;
        },
        de = function e(t, n) {
          ...
          return (
            Object.keys(t).forEach(function (n) {
              if (!le(t[n])) {
                if (m(t[n])) return a.push.apply(a, e(t[n], n)), a;
                if (p(t[n])) return a.push(ue(n) + ":", t[n], ";"), a;
                a.push(
                  ue(n) +
                    ": " +
                    ((r = n),
      ...
      function ce(e, t, n) {
        if (Array.isArray(e)) {
          for (var a, r = [], i = 0, s = e.length; i < s; i += 1)
            "" !== (a = ce(e[i], t, n)) &&
      ...
      function pe(e) {
        ...
        for (var r = 0, i = n; r < i.length; r++) {
          var s = i[r];
          if (me(s)) for (var o in s) fe(o) && he(e, s[o], o);
        }
        return e;
      }
      var ye = /(a)(d)/gi,
      ...
      function ge(e) {
        var t,
          n = "";
        for (t = Math.abs(e); t > Me; t = (t / Me) | 0) n = Le(t % Me) + n;
        return (Le(t % Me) + n).replace(ye, "$1-$2");
      }
      function Ye(e) {
          ...
          return (
            (e.prototype.generateAndInjectStyles = function (e, t, n) {
              ...
              if (this.isStatic && !n.hash) {
                ...
                var r = ce(this.rules, e, t).join(""),
                  i = ge(Q(this.baseHash, r.length) >>> 0);
                if (!t.hasNameForId(a, i)) {
                  var s = n(r, "." + i, void 0, a);
                  t.insertRules(a, i, s);
                }
                return (this.staticRulesId = i), i;
              }
              for (
                var o = this.rules.length,
      ...
      function je(e, t, n) {
            ...
            return (
              n.forEach(function (e) {
                var t,
                  ...
                  i,
                  s = e;
                for (t in (p(s) && (s = s(a)), s))
                  a[t] = r[t] =
                    "className" === t
                      ? ((n = r[t]), (i = s[t]), n && i ? n + " " + i : n || i)
                      : s[t];
              }),
              [a, r]
            );
          })(ve(t, Object(r.useContext)(xe), s) || h, t, a),
          m = _[0],
          f = _[1],
          y = (function (e, t, n, a) {
            var i = ae(),
              ...
              o =
                e.isStatic && !t
                  ? e.generateAndInjectStyles(h, i, s)
                  : e.generateAndInjectStyles(n, i, s);
        ...
        return (
          t.style &&
            f.style !== t.style &&
            (v.style = c({}, t.style, {}, f.style)),
          (v.className = Array.prototype
            .concat(o, l, y !== l ? y : null, t.className, f.className)
            .filter(Boolean)
            .join(" ")),
          (v.ref = M),
          Object(r.createElement)(L, v)
        );
      }
      function Ee(e, t, n) {
        var a,
          ...
          u =
            void 0 === o
              ? (function (e) {
                  return De(e) ? "styled." + e : "Styled(" + y(e) + ")";
                })(e)
              : o,
          l = t.componentId,
          _ =
          ...
          L =
            r && e.attrs
              ...
              : h,
          g = new ke(r ? e.componentStyle.rules.concat(n) : n, p),
          Y = function (e, t) {
            return je(a, e, t);
          };
        return (
          (Y.displayName = u),
          ((a = i.a.forwardRef(Y)).attrs = L),
          (a.componentStyle = g),
          (a.displayName = u),
          (a.foldedComponentIds = r
            ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId)
            : f),
          (a.styledComponentId = p),
          (a.target = r ? e.target : e),
          (a.withComponent = function (e) {
            var a = t.componentId,
              ...
              i = a && a + "-" + (De(e) ? e : Te(y(e)));
            return Ee(e, c({}, r, { attrs: L, componentId: i }), n);
          }),
      ...
      var Pe = function (e) {
        return (function e(t, n, r) {
          if ((void 0 === r && (r = h), !Object(a.isValidElementType)(n)))
            return w(1, String(n));
          var i = function () {
  ...
  function (e, t, n) {
    ...
    var a = n(3),
      ...
      o = {};
    function u(e) {
      return a.isMemo(e) ? s : o[e.$$typeof] || r;
    }
    (o[a.ForwardRef] = {
      $$typeof: !0,
      render: !0,
    ...
    e.exports = function e(t, n, a) {
      if ("string" != typeof n) {
        ...
        var s = d(n);
        c && (s = s.concat(c(n)));
        for (var o = u(t), h = u(n), p = 0; p < s.length; ++p) {
          var y = s[p];
          if (!(i[y] || (a && a[y]) || (h && h[y]) || (o && o[y]))) {
            var M = _(n, y);
            try {
              l(t, y, M);
            } catch (e) {}
      ...
      var t = {
        ...
        r = function (e) {
          return function (t, r, i, s) {
            var o = n(t),
              u = a[e][n(t)];
            return 2 === o && (u = u[r ? 0 : 1]), u.replace(/%d/i, t);
          };
        },
        i = [
          "يناير",
    ...
    t.a = function (e) {
      ...
      function a(e, t, n, i) {
        ...
        if (944 === o) {
          ...
          return (
            ...
            1 === x || (2 === x && r(u, 1)) ? "-webkit-" + u + u : u
          );
        }
        if (0 === x || (2 === x && !r(s, 1))) return s;
        switch (o) {
          case 1015:
          ...
          case 883:
            ...
            if (0 < s.indexOf("image-set(", 11))
              return s.replace(w, "$1-webkit-$2") + s;
            break;
          case 932:
          ...
          case 1005:
            return _.test(s)
              ? s.replace(c, ":-webkit-") + s.replace(c, ":-moz-") + s
              : s;
          case 1e3:
            switch (
          ...
          case 938:
            if (45 === s.charCodeAt(5))
              switch (s.charCodeAt(6)) {
                ...
                case 115:
                  return (
                    "-webkit-" + s + "-ms-flex-item-" + s.replace(k, "") + s
                  );
                default:
                  return (
                    "-webkit-" +
                    s +
                    "-ms-flex-line-pack" +
                    s.replace("align-content", "").replace(k, "") +
                    s
                  );
              }
            break;
          ...
          case 953:
            if (!0 === b.test(e))
              return 115 === (u = e.substring(e.indexOf(":") + 1)).charCodeAt(0)
                ? a(e.replace("stretch", "fill-available"), t, n, i).replace(
                    ":fill-available",
                    ":stretch"
                  )
                : s.replace(u, "-webkit-" + u) +
      ...
      function r(e, t) {
        ...
        return (
          ...
          P(2 !== t ? a : a.replace(v, "$1"), n, t)
        );
      }
      function i(e, t) {
        var n = a(t, t.charCodeAt(0), t.charCodeAt(1), t.charCodeAt(2));
        return n !== t + ";"
          ? n.replace(Y, " or ($1)").substring(4)
          : "(" + t + ")";
      }
      function s(e, t, n, a, r, i, s, o, l, d) {
        for (var c, _ = 0, m = t; _ < E; ++_)
          switch ((c = j[_].call(u, e, m, n, a, r, i, s, o, l, d))) {
            case void 0:
            case !1:
            case !0:
            case null:
      ...
      function u(e, n) {
        var o = e;
        if ((33 > o.charCodeAt(0) && (o = o.trim()), (o = [o]), 0 < E)) {
          var u = s(-1, n, o, o, D, T, 0, 0, 0, 0);
          void 0 !== u && "string" == typeof u && (n = u);
        }
        var c = (function e(n, o, u, c, _) {
          for (
            var m,
              f,
              h,
            ...
            if (
              ...
              if (
                A === R &&
                (0 < W && (I = I.replace(d, "")), 0 < I.trim().length)
              ) {
                switch (f) {
                  case 32:
                  case 9:
              ...
              switch (f) {
                case 123:
                  for (
                    m = (I = I.trim()).charCodeAt(0), h = 1, z = ++A;
                    A < N;

                  ) {
                    switch ((f = u.charCodeAt(A))) {
                      case 123:
                        h++;
                        break;
                      case 125:
                        ...
                        break;
                      case 47:
                        switch ((f = u.charCodeAt(A + 1))) {
                          case 42:
                          case 47:
                            e: {
                              for (C = A + 1; C < R; ++C)
                                switch (u.charCodeAt(C)) {
                                  case 47:
                                    if (
                                      42 === f &&
                                      42 === u.charCodeAt(C - 1) &&
                  ...
                  switch (
                    ((h = u.substring(z, A)),
                    0 === m &&
                      (m = (I = I.replace(l, "").trim()).charCodeAt(0)),
                    m)
                  ) {
                    case 64:
                      switch (
                        (0 < W && (I = I.replace(d, "")), (f = I.charCodeAt(1)))
                      ) {
                        case 100:
                        case 109:
                        case 115:
                      ...
                      if (
                        ((z = (h = e(o, W, h, f, _ + 1)).length),
                        0 < E &&
                          ((Y = s(3, h, (W = t(H, I, F)), o, D, T, z, f, _, c)),
                          (I = W.join("")),
                          void 0 !== Y &&
                            0 === (z = (h = Y.trim()).length) &&
                            ((f = 0), (h = ""))),
                ...
                case 59:
                  if (
                    1 < (z = (I = (0 < W ? I.replace(d, "") : I).trim()).length)
                  )
                    switch (
                      (0 === C &&
                        ((m = I.charCodeAt(0)),
                        45 === m || (96 < m && 123 > m)) &&
                        (z = (I = I.replace(" ", ":")).length),
                      0 < E &&
                        void 0 !==
                          (Y = s(1, I, o, n, D, T, U.length, c, _, c)) &&
                        0 === (z = (I = Y.trim()).length) &&
                        (I = "\0\0"),
                      (m = I.charCodeAt(0)),
                      (f = I.charCodeAt(1)),
                      ...
                      default:
                        58 !== I.charCodeAt(z - 1) &&
                          (U += a(I, m, f, I.charCodeAt(2)));
                    }
                  (F = W = C = m = 0), (I = ""), (f = u.charCodeAt(++A));
              }
            }
            switch (f) {
              case 13:
              case 10:
                47 === v
                  ...
                  : 0 === 1 + m &&
                    ...
                    0 < I.length &&
                    ((W = 1), (I += "\0")),
                  0 < E * O && s(0, I, o, n, D, T, U.length, c, _, c),
                  (T = 1),
                  D++;
                break;
              case 59:
          ...
          if (0 < (z = U.length)) {
            if (
              ((W = o),
              0 < E &&
                void 0 !== (Y = s(2, U, W, n, D, T, z, c, _, c)) &&
                0 === (U = Y).length)
            )
              return V + U + J;
            if (((U = W.join(",") + "{" + U + "}"), 0 != x * S)) {
              switch ((2 !== x || r(U, 2) || (S = 0), S)) {
                case 111:
        ...
        return (
          0 < E &&
            void 0 !== (u = s(-2, c, o, o, D, T, c.length, 0, 0, 0)) &&
            (c = u),
          (S = 0),
          (T = D = 1),
          c
...
`,
  ...
  margin-left: 10px;
`;
    var f = ({ label: e, info: t, children: n }) =>
      r.a.createElement(
        c,
        null,
        r.a.createElement(_, null, e),
        n,
        r.a.createElement(m, null, t)
      );
    const h = o.a.input`
  padding: 10px;
  color: #ff857e;
`;
    var p = ({
      ...
      return r.a.createElement(
        ...
        r.a.createElement(
          f,
          { label: "Amount requested", info: "(in £)" },
          r.a.createElement(h, {
            type: "number",
            onChange: (t) => {
        ...
        r.a.createElement(
          f,
          { label: "Amount requested", info: "(in months)" },
          r.a.createElement(h, {
            type: "number",
            min: 0,
            step: 1,
...
`;
    var g = ({ label: e, amount: t, duration: n, calculation: i }) => {
      const [s, o] = Object(a.useState)(3),
        u = i(t, n, s),
        l = ((e) => {
          let t = 0,
            n = 0,
          ...
          return (
            e.forEach((e) => {
              (t += e.principal), (n += e.interest), (a += e.total);
            }),
            { principal: t, interest: n, total: a }
          );
        })(u),
        d = (e) => e.toFixed(2);
      return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                "tr",
                null,
                r.a.createElement("th", null, "Repayment date"),
                r.a.createElement("th", null, "Principal"),
                r.a.createElement("th", null, "Interest"),
                r.a.createElement("th", null, "Total repayment")
              )
            ),
            r.a.createElement(
              "tbody",
              ...
              u.map((e, t) =>
                r.a.createElement(
                  "tr",
                  { key: `tuple_${t}` },
                  r.a.createElement("td", null, e.repaymentDate),
                  r.a.createElement("td", null, d(e.principal)),
                  r.a.createElement("td", null, d(e.interest)),
                  r.a.createElement("td", null, d(e.total))
                )
              ),
              r.a.createElement(
                "tr",
                ...
                r.a.createElement("td", null, d(l.principal)),
                r.a.createElement("td", null, d(l.interest)),
                r.a.createElement("td", null, d(l.total))
              )
            )
          )
      );
    ...
    const Y = (e, t, n) => {
        let a = s()();
        return [...Array(t)].map((r, i) => {
          const s = e / t,
            o = (n / 100) * (e - i * s),
            u = {
              repaymentDate: a.format("L"),
              principal: s,
              interest: o,
              total: s + o,
            };
    ...
    s.a.locale("en-gb");
    t.a = () => {
      const [e, t] = Object(a.useState)(1e4),
        [n, i] = Object(a.useState)(4);
      return r.a.createElement(
        u,
        null,
        r.a.createElement(l, null, "Your loan"),
        r.a.createElement(p, {
          onAmountChanged: t,
          onDurationChanged: i,
          amount: e,
      ...
      function (e) {
        ...
        a.a.render(
          ...
          e &&
            e.hot &&
            (e.hot.accept(),
            e.hot.addStatusHandler((e) => {
              "prepare" === e && console.clear();
            }));
      }.call(this, n(141)(e));
  },
  function (e, t) {
  ...
  function (e, t, n) {
    ...
    function p(e, t, n) {
      ...
      (e.currentTarget = h(n)),
        (function (e, t, n, a, r, i, c, m, f) {
          if ((_.apply(this, arguments), o)) {
            if (!o) throw Error(s(198));
            var h = u;
            (o = !1), (u = null), l || ((l = !0), (d = h));
          }
        })(a, t, void 0, e),
      ...
      if (y)
        for (var e in M) {
          ...
          if (!Y[n]) {
            ...
            for (var a in ((Y[n] = t), (n = t.eventTypes))) {
              var r = void 0,
                i = n[a],
                o = t,
                u = a;
              if (k.hasOwnProperty(u)) throw Error(s(99, u));
              k[u] = i;
              var l = i.phasedRegistrationNames;
              if (l) {
                for (r in l) l.hasOwnProperty(r) && g(l[r], o, u);
                r = !0;
              } else
                i.registrationName
                  ? (g(i.registrationName, o, u), (r = !0))
                  : (r = !1);
    ...
    function g(e, t, n) {
      ...
      (v[e] = t), (b[e] = t.eventTypes[n].dependencies);
    }
    var Y = [],
      k = {},
      v = {},
    ...
    function w(e) {
      ...
      for (t in e)
        if (e.hasOwnProperty(t)) {
          var a = e[t];
          if (!M.hasOwnProperty(t) || M[t] !== a) {
            if (M[t]) throw Error(s(102, t));
            (M[t] = a), (n = !0);
          }
        }
      n && L();
    ...
    function H(e) {
      if ((e = f(e))) {
        if ("function" != typeof D) throw Error(s(280));
        var t = e.stateNode;
        t && ((t = m(t)), D(e.stateNode, e.type, t));
      }
    }
    function j(e) {
      S ? (x ? x.push(e) : (x = [e])) : (S = e);
    }
    function E() {
      if (S) {
        var e = S,
          t = x;
        if (((x = S = null), H(e), t)) for (e = 0; e < t.length; e++) H(t[e]);
      }
    }
    function P(e, t) {
      return e(t);
      ...
      (null !== r
        ...
        a || null === r
          ? (function (e) {
              return (
                !!I.call(J, e) ||
                (!I.call(U, e) && (R.test(e) ? (J[e] = !0) : ((U[e] = !0), !1)))
              );
            })(t) &&
    ...
    var q = /^(.*)[\\\/]/,
      ...
      ce = Z ? Symbol.for("react.lazy") : 60116,
      _e = Z ? Symbol.for("react.block") : 60121,
    ...
    function ge(e) {
      ...
      var n = t.getValue(),
        a = "";
      return (
        e && (a = Me(e) ? (e.checked ? "true" : "false") : e.value),
    ...
    function Ve(e) {
      ...
      var t,
        n = Ie[e];
      for (t in n) if (n.hasOwnProperty(t) && t in Je) return (Ue[e] = n[t]);
      return e;
    }
    T &&
    ...
    function mt(e) {
      ...
      do {
        ...
        if (!a) break;
        (5 !== (t = n.tag) && 6 !== t) || e.ancestors.push(n), (n = xn(a));
      } while (n);
      for (n = 0; n < e.ancestors.length; n++) {
        ...
        0 === n && (s |= 64);
        for (var o = null, u = 0; u < Y.length; u++) {
          var l = Y[u];
          l && (l = l.extractEvents(a, t, i, r, s)) && (o = at(o, l));
        }
        ot(o);
      }
    }
    ...
    function Ot() {
      for (Mt = !1; 0 < Lt.length; ) {
        var e = Lt[0];
        if (null !== e.blockedOn) {
          null !== (e = Hn(e.blockedOn)) && ht(e);
          break;
        }
        var t = Kt(
          e.topLevelType,
    ...
    function At(e) {
      ...
      for (
        ...
        (a = wt[n]).blockedOn === e && (a.blockedOn = null);
      for (; 0 < wt.length && null === (n = wt[0]).blockedOn; )
        jt(n), null === n.blockedOn && wt.shift();
    }
    var Wt = {},
      Ft = new Map(),
      zt = new Map(),
    ...
    Rt(
      ...
      Rt(Nt, 2);
    for (
      var It = "change selectionchange textInput compositionstart compositionend compositionupdate".split(
          " "
        ),
        Ut = 0;
      Ut < It.length;
    ...
    function Qt(e, t, n, a) {
      if ($t)
        if (0 < Lt.length && -1 < Tt.indexOf(e))
          (e = St(null, e, t, n, a)), Lt.push(e);
        else {
          var r = Kt(e, t, n, a);
          if (null === r) xt(e, a);
          else if (-1 < Tt.indexOf(e)) (e = St(r, e, t, n, a)), Lt.push(e);
          else if (
            !(function (e, t, n, a, r) {
              switch (t) {
                case "focus":
                ...
                case "gotpointercapture":
                  return (
                    (i = r.pointerId),
                    bt.set(i, Ht(bt.get(i) || null, e, t, n, a, r)),
                    !0
                  );
              }
              return !1;
    ...
    var wn = Math.random().toString(36).slice(2),
      Tn = "__reactInternalInstance$" + wn,
      Dn = "__reactEventHandlers$" + wn,
    ...
    function An(e) {
      if (e && e.dispatchConfig.phasedRegistrationNames) {
        ...
        for (t = n.length; 0 < t--; ) Cn(n[t], "captured", e);
        for (t = 0; t < n.length; t++) Cn(n[t], "bubbled", e);
      }
    }
    function Wn(e, t, n) {
      e &&
    ...
    function Un() {
      ...
      return (In = r.slice(e, 1 < t ? 1 - t : void 0));
    }
    function Jn() {
      return !0;
    }
    ...
    var Kn = $n.extend({ data: null }),
      ...
      ea = null;
    T && "documentMode" in document && (ea = document.documentMode);
    var ta = T && "TextEvent" in window && !ea,
      na = T && (!Xn || (ea && 8 < ea && 11 >= ea)),
    ...
    var la = {
        ...
        extractEvents: function (e, t, n, a) {
          ...
          if (Xn)
            e: {
              switch (e) {
                case "compositionstart":
                  var i = ra.compositionStart;
                  break e;
                case "compositionend":
                  i = ra.compositionEnd;
                  break e;
                case "compositionupdate":
                  i = ra.compositionUpdate;
                  break e;
              }
              i = void 0;
            }
            ...
            ua
              ? sa(e, n) && (i = ra.compositionEnd)
              : "keydown" === e &&
                229 === n.keyCode &&
                (i = ra.compositionStart);
          return (
            i
              ? (na &&
                  "ko" !== n.locale &&
                  (ua || i !== ra.compositionStart
                    ? i === ra.compositionEnd && ua && (r = Un())
                    : ((Rn = "value" in (Nn = a) ? Nn.value : Nn.textContent),
                      (ua = !0))),
                (i = Kn.getPooled(i, t, n, a)),
                r ? (i.data = r) : null !== (r = oa(n)) && (i.data = r),
                zn(i),
                (r = i))
              : (r = null),
            (e = ta
              ? (function (e, t) {
                  switch (e) {
                    case "compositionend":
                      return oa(t);
                    case "keypress":
                      return 32 !== t.which ? null : ((ia = !0), aa);
                    case "textInput":
                      return (e = t.data) === aa && ia ? null : e;
                    default:
                      return null;
                  }
                })(e, n)
              : (function (e, t) {
                  if (ua)
                    return "compositionend" === e || (!Xn && sa(e, t))
                      ? ((e = Un()), (In = Rn = Nn = null), (ua = !1), e)
                      : null;
                  switch (e) {
                    case "paste":
                      return null;
              ...
              ? (((t = qn.getPooled(ra.beforeInput, t, n, a)).data = e), zn(t))
              : (t = null),
    ...
    function ma(e, t, n) {
      return (
        ((e = $n.getPooled(_a.change, e, t, n)).type = "change"), j(n), zn(e), e
      );
    }
    var fa = null,
      ha = null;
    ...
    var La = !1;
    function ga() {
      fa && (fa.detachEvent("onpropertychange", Ya), (ha = fa = null));
    }
    function Ya(e) {
      if ("value" === e.propertyName && ya(ha))
        if (((e = ma(ha, e, ut(e))), W)) ot(e);
        else {
          W = !0;
          try {
            P(pa, e);
    ...
    function ka(e, t, n) {
      "focus" === e
        ? (ga(), (ha = n), (fa = t).attachEvent("onpropertychange", Ya))
        : "blur" === e && ga();
    }
    function va(e) {
    ...
    var Ta = {
        ...
        extractEvents: function (e, t, n, a) {
          ...
          if ("select" === i || ("input" === i && "file" === r.type))
            var s = Ma;
          else if (ca(r))
            if (La) s = wa;
            else {
      ...
      Da = $n.extend({ view: null, detail: null }),
      Sa = {
        Alt: "altKey",
        Control: "ctrlKey",
        Meta: "metaKey",
    ...
    var ja = 0,
      ...
      Ca = Da.extend({
        ...
        movementX: function (e) {
          ...
          return (
            (ja = e.screenX),
            Pa ? ("mousemove" === e.type ? e.screenX - t : 0) : ((Pa = !0), 0)
          );
        },
      ...
      Fa = {
        ...
        extractEvents: function (e, t, n, a, r) {
          ...
          if (
            (i && 0 == (32 & r) && (n.relatedTarget || n.fromElement)) ||
            (!s && !i)
          )
            return null;
          ((i =
          ...
          if (
            ((e = null == s ? i : jn(s)),
            (i = null == t ? i : jn(t)),
            ((u = o.getPooled(u, s, n, a)).type = d + "leave"),
            (u.target = e),
            (u.relatedTarget = i),
            ((n = o.getPooled(l, t, n, a)).type = d + "enter"),
            (n.target = i),
            (n.relatedTarget = e),
            (d = t),
            (a = s) && d)
          ...
          for (
            l = o, o = [];
            a && a !== l && (null === (s = a.alternate) || s !== l);

          )
            o.push(a), (a = Pn(a));
          for (
            a = [];
            d && d !== l && (null === (s = d.alternate) || s !== l);

          )
            a.push(d), (d = Pn(d));
          for (d = 0; d < o.length; d++) Wn(o[d], "bubbled", u);
          for (d = a.length; 0 < d--; ) Wn(a[d], "captured", n);
          return 0 == (64 & r) ? [u] : [u, n];
        },
      };
    var za =
    ...
    function Ra(e, t) {
      ...
      for (a = 0; a < n.length; a++)
        if (!Na.call(t, n[a]) || !za(e[n[a]], t[n[a]])) return !1;
      return !0;
    }
    var Ia = T && "documentMode" in document && 11 >= document.documentMode,
      Ua = {
        select: {
          phasedRegistrationNames: {
            bubbled: "onSelect",
    ...
    function Ba(e, t) {
      ...
      return Ga || null == Ja || Ja !== un(n)
        ? null
        : ("selectionStart" in (n = Ja) && _n(n)
          ...
          $a && Ra($a, n)
            ? null
            : (($a = n),
              ((e = $n.getPooled(Ua.select, Va, e, t)).type = "select"),
              (e.target = Ja),
              zn(e),
              e));
    }
    var Qa = {
        ...
        extractEvents: function (e, t, n, a, r, i) {
          ...
          if (i) return null;
          switch (((r = t ? jn(t) : window), e)) {
            case "focus":
              (ca(r) || "true" === r.contentEditable) &&
                ((Ja = r), (Va = t), ($a = null));
              break;
            case "blur":
              $a = Va = Ja = null;
      ...
      Za = Da.extend({ relatedTarget: null });
    function Xa(e) {
      var t = e.keyCode;
      return (
        "charCode" in e
    ...
    var er = {
      ...
      ar = Ca.extend({ dataTransfer: null }),
      rr = Da.extend({
        touches: null,
        targetTouches: null,
        changedTouches: null,
      ...
      or = {
        ...
        extractEvents: function (e, t, n, a) {
          ...
          return zn((t = e.getPooled(r, t, n, a))), t;
        },
      };
    if (y) throw Error(s(101));
    ...
    function Lr(e, t, n) {
      if (mr.current !== _r) throw Error(s(168));
      cr(mr, t), cr(fr, n);
    }
    function gr(e, t, n) {
      var a = e.stateNode;
    ...
    function Jr(e, t) {
      return (e = Ur(e)), vr(e, t);
    }
    function Vr(e, t, n) {
      return (e = Ur(e)), br(e, t, n);
    }
    function $r(e) {
      return null === Wr ? ((Wr = [e]), (Fr = br(xr, Br))) : Wr.push(e), Or;
    }
    function Gr() {
      if (null !== Fr) {
        var e = Fr;
    ...
    function Br() {
      if (!zr && null !== Wr) {
        ...
        try {
          ...
          throw (null !== Wr && (Wr = Wr.slice(e + 1)), br(xr, Gr), t);
        } finally {
          zr = !1;
        }
      }
    ...
    function ri(e, t) {
      (Zr = e),
        ...
        null !== (e = e.dependencies) &&
          null !== e.firstContext &&
          (e.expirationTime >= t && (js = !0), (e.firstContext = null));
    }
    function ii(e, t) {
      if (ei !== e && !1 !== t && 0 !== t)
        if (
      ...
      if (((e = t.effects), (t.effects = null), null !== e))
        for (t = 0; t < e.length; t++) {
          var a = e[t],
            r = a.callback;
          if (null !== r) {
            if (((a.callback = null), (a = r), (r = n), "function" != typeof a))
              throw Error(s(191, a));
            a.call(r);
          }
        }
    ...
    var yi = {
      ...
      enqueueForceUpdate: function (e, t) {
        ...
        var n = au(),
          a = fi.suspense;
        ((a = li((n = ru(n, e, a)), a)).tag = 2),
          null != t && (a.callback = t),
          di(e, a),
          iu(e, n);
      },
    };
    function Mi(e, t, n, a, r, i, s) {
    ...
    function Li(e, t, n) {
      ...
      return (
        "object" == typeof i && null !== i
          ? (i = ii(i))
          : ((r = yr(t) ? hr : mr.current),
            (i = (a = null != (a = t.contextTypes)) ? pr(e, r) : _r)),
        (t = new t(n, i)),
        (e.memoizedState =
    ...
    function Yi(e, t, n, a) {
      var r = e.stateNode;
      (r.props = n), (r.state = e.memoizedState), (r.refs = hi), oi(e);
      var i = t.contextType;
      "object" == typeof i && null !== i
        ? (r.context = ii(i))
        : ((i = yr(t) ? hr : mr.current), (r.context = pr(e, i))),
        _i(e, n, r, a),
        (r.state = e.memoizedState),
        "function" == typeof (i = t.getDerivedStateFromProps) &&
          (pi(e, t, i, n), (r.state = e.memoizedState)),
    ...
    function wi(e) {
      ...
      function u(e, t, n, a) {
        return null === t || 6 !== t.tag
          ? (((t = Wu(n, e.mode, a)).return = e), t)
          : (((t = r(t, n)).return = e), t);
      }
      function l(e, t, n, a) {
        return null !== t && t.elementType === n.type
          ? (((a = r(t, n.props)).ref = vi(e, t, n)), (a.return = e), a)
          : (((a = Cu(n.type, n.key, n.props, null, e.mode, a)).ref = vi(
              e,
              t,
              n
            )),
      ...
      function d(e, t, n, a) {
        return null === t ||
          ...
          ? (((t = Fu(n, e.mode, a)).return = e), t)
          : (((t = r(t, n.children || [])).return = e), t);
      }
      function c(e, t, n, a, i) {
        return null === t || 7 !== t.tag
          ? (((t = Au(n, e.mode, a, i)).return = e), t)
          : (((t = r(t, n)).return = e), t);
      }
      function _(e, t, n) {
        ...
        if ("object" == typeof t && null !== t) {
          switch (t.$$typeof) {
            case X:
              return (
                ((n = Cu(t.type, t.key, t.props, null, e.mode, n)).ref = vi(
                  e,
                  null,
                  t
                )),
        ...
        if ("object" == typeof n && null !== n) {
          switch (n.$$typeof) {
            case X:
              return n.key === r
                ? n.type === te
                  ? c(e, t, n.props.children, a, r)
                  : l(e, t, n, a)
                : null;
            case ee:
              return n.key === r ? d(e, t, n, a) : null;
          }
          if (ki(n) || fe(n)) return null !== r ? null : c(e, t, n, a, null);
          bi(e, n);
        }
        return null;
      }
      function f(e, t, n, a, r) {
        ...
        if ("object" == typeof a && null !== a) {
          switch (a.$$typeof) {
            case X:
              return (
                ...
                a.type === te
                  ? c(t, e, a.props.children, r, a.key)
                  : l(t, e, a, r)
              );
            case ee:
              return d(
          ...
          if (ki(a) || fe(a)) return c(t, (e = e.get(n) || null), a, r, null);
          bi(t, a);
        }
        return null;
      }
      ...
      function p(r, o, u, l) {
        ...
        if (M.done) return n(r, h), d;
        if (null === h) {
          for (; !M.done; p++, M = u.next())
            null !== (M = _(r, M.value, l)) &&
              ((o = i(M, o, p)),
              null === c ? (d = M) : (c.sibling = M),
              (c = M));
          return d;
        }
        for (h = a(r, h); !M.done; p++, M = u.next())
      ...
      return function (e, a, i, u) {
        ...
        if (d)
          switch (i.$$typeof) {
            case X:
              e: {
                for (d = i.key, l = a; null !== l; ) {
                  if (l.key === d) {
                    switch (l.tag) {
                      case 7:
                        if (i.type === te) {
                          n(e, l.sibling),
                            ((a = r(l, i.props.children)).return = e),
                            (e = a);
                          break e;
                        }
                        break;
                ...
                i.type === te
                  ? (((a = Au(i.props.children, e.mode, u, i.key)).return = e),
                    (e = a))
                  : (((u = Cu(
                      i.type,
                      i.key,
        ...
        if ("string" == typeof i || "number" == typeof i)
          return (
            ...
            null !== a && 6 === a.tag
              ...
              : (n(e, a), ((a = Wu(i, e.mode, u)).return = e), (e = a)),
            o(e)
          );
        if (ki(i)) return h(e, a, i, u);
        if (fe(i)) return p(e, a, i, u);
        if ((d && bi(e, i), void 0 === i && !l))
          switch (e.tag) {
            case 1:
            case 0:
              throw (
    ...
    function Pi(e, t) {
      switch ((cr(ji, t), cr(Hi, e), cr(xi, Si), (e = t.nodeType))) {
        case 9:
        case 11:
    ...
    function Fi(e) {
      for (var t = e; null !== t; ) {
        if (13 === t.tag) {
          ...
          if (
            null !== n &&
            (null === (n = n.dehydrated) || n.data === hn || n.data === pn)
          )
            return t;
    ...
    var Ni = Q.ReactCurrentDispatcher,
      Ri = Q.ReactCurrentBatchConfig,
      Ii = 0,
      Ui = null,
      Ji = null,
      Vi = null,
    ...
    function Qi(e, t, n, a, r, i) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (Ni.current = null === e || null === e.memoizedState ? Ms : Ls),
        (e = n(a, r)),
        t.expirationTime === Ii)
      ) {
        i = 0;
    ...
    function Ki() {
      ...
      return null === Vi ? (Ui.memoizedState = Vi = e) : (Vi = Vi.next = e), Vi;
    }
    function qi() {
      if (null === Ji) {
        var e = Ui.alternate;
      ...
      if (null !== r) {
        ...
        do {
          ...
          if (d < Ii) {
            ...
            null === u ? ((o = u = c), (i = a)) : (u = u.next = c),
              d > Ui.expirationTime && ((Ui.expirationTime = d), pu(d));
          } else
            null !== u &&
              (u = u.next = {
                expirationTime: 1073741823,
              ...
              hu(d, l.suspenseConfig),
              (a = l.eagerReducer === e ? l.eagerState : e(a, l.action));
          l = l.next;
        } while (null !== l && l !== r);
        null === u ? (i = a) : (u.next = o),
          za(a, t.memoizedState) || (js = !0),
          (t.memoizedState = a),
          (t.baseState = i),
          (t.baseQueue = u),
    ...
    function rs(e, t, n, a) {
      var r = Ki();
      (Ui.effectTag |= e),
        (r.memoizedState = ns(1 | t, n, void 0, void 0 === a ? null : a));
    }
    function is(e, t, n, a) {
      var r = qi();
      a = void 0 === a ? null : a;
      ...
      if (null !== Ji) {
        ...
        if (((i = s.destroy), null !== a && Bi(a, s.deps)))
          return void ns(t, n, i, a);
      }
      (Ui.effectTag |= e), (r.memoizedState = ns(1 | t, n, i, a));
    }
    function ss(e, t) {
      return rs(516, 4, e, t);
    }
    ...
    function ds(e, t, n) {
      return (
        (n = null != n ? n.concat([e]) : null), is(4, 2, ls.bind(null, t, e), n)
      );
    }
    function cs() {}
    function _s(e, t) {
    ...
    function hs(e, t, n) {
      var a = Ir();
      Jr(98 > a ? 98 : a, function () {
        e(!0);
      }),
        Jr(97 < a ? 97 : a, function () {
          var a = Ri.suspense;
          Ri.suspense = void 0 === t ? null : t;
          try {
            e(!1), n();
          } finally {
            Ri.suspense = a;
    ...
    function ps(e, t, n) {
      ...
      if (
        ...
        ($i = !0), (r.expirationTime = Ii), (Ui.expirationTime = Ii);
      else {
        if (
          0 === e.expirationTime &&
          ...
          try {
            var s = t.lastRenderedState,
              o = i(s, n);
            if (((r.eagerReducer = i), (r.eagerState = o), za(o, s))) return;
          } catch (e) {}
        iu(e, a);
      }
    }
    var ys = {
      ...
      Ms = {
        ...
        useTransition: function (e) {
          var t = ts(!1),
            n = t[0];
          return (t = t[1]), [_s(hs.bind(null, t, e), [t, e]), n];
        },
      },
      Ls = {
        readContext: ii,
        ...
        useTransition: function (e) {
          var t = Xi(Zi),
            n = t[0];
          return (t = t[1]), [ms(hs.bind(null, t, e), [t, e]), n];
        },
      },
      gs = {
        readContext: ii,
    ...
    function Ts(e) {
      if (vs) {
        ...
        if (t) {
          ...
          (Ys = e), (ks = vn(t.firstChild));
        } else (e.effectTag = (-1025 & e.effectTag) | 2), (vs = !1), (Ys = e);
      }
    }
    function Ds(e) {
      for (
    ...
    function Ss(e) {
      if (e !== Ys) return !1;
      if (!vs) return Ds(e), (vs = !0), !1;
      var t = e.type;
      if (
        5 !== e.tag ||
        ("head" !== t && "body" !== t && !gn(t, e.memoizedProps))
      )
        for (t = ks; t; ) bs(e, t), (t = vn(t.nextSibling));
      if ((Ds(e), 13 === e.tag)) {
          ...
          for (e = e.nextSibling, t = 0; e; ) {
            if (8 === e.nodeType) {
              ...
              if (n === fn) {
                ...
                t--;
              } else (n !== mn && n !== pn && n !== hn) || t++;
            }
            e = e.nextSibling;
          }
          ks = null;
        }
      } else ks = Ys ? vn(e.stateNode.nextSibling) : null;
      return !0;
    }
    function xs() {
      (ks = Ys = null), (vs = !1);
    }
    var Hs = Q.ReactCurrentOwner,
      js = !1;
    function Es(e, t, n, a) {
    ...
    function Ps(e, t, n, a, r) {
      ...
      return (
        ...
        (a = Qi(e, t, n, a, i, r)),
        null === e || js
          ? ((t.effectTag |= 1), Es(e, t, a, r), t.child)
    ...
    function Os(e, t, n, a, r, i) {
      if (null === e) {
        ...
        return "function" != typeof s ||
          ...
          ? (((e = Cu(n.type, null, a, null, t.mode, i)).ref = t.ref),
            (e.return = t),
            (t.child = e))
          : ((t.tag = 15), (t.type = s), Cs(e, t, s, a, r, i));
      }
      return (
        (s = e.child),
        r < i &&
        ((r = s.memoizedProps),
        (n = null !== (n = n.compare) ? n : Ra)(r, a) && e.ref === t.ref)
          ? Ks(e, t, i)
          : ((t.effectTag |= 1),
            ((e = Ou(s, a)).ref = t.ref),
            (e.return = t),
    ...
    function Cs(e, t, n, a, r, i) {
      return null !== e &&
        Ra(e.memoizedProps, a) &&
        e.ref === t.ref &&
        ((js = !1), r < i)
        ? ((t.expirationTime = e.expirationTime), Ks(e, t, i))
        : Ws(e, t, n, a, i);
    }
    function As(e, t) {
      var n = t.ref;
    ...
    function Ws(e, t, n, a, r) {
      var i = yr(n) ? hr : mr.current;
      return (
        (i = pr(t, i)),
        ri(t, r),
        (n = Qi(e, t, n, a, i, r)),
        null === e || js
          ? ((t.effectTag |= 1), Es(e, t, n, r), t.child)
          : ((t.updateQueue = e.updateQueue),
            (t.effectTag &= -517),
            e.expirationTime <= r && (e.expirationTime = 0),
            Ks(e, t, r))
    ...
    function Fs(e, t, n, a, r) {
      ...
      if ((ri(t, r), null === t.stateNode))
        ...
        (s.state = _),
          _i(t, a, s, r),
          (u = t.memoizedState),
          o !== a || _ !== u || fr.current || si
            ? ("function" == typeof d &&
                (pi(t, n, d, a), (u = t.memoizedState)),
              (o = si || Mi(t, n, o, a, _, u, l))
                ? (c ||
        ...
        (s = t.stateNode),
          ui(e, t),
          (o = t.memoizedProps),
          (s.props = t.type === t.elementType ? o : Kr(t.type, o)),
          (u = s.context),
          ...
          _i(t, a, s, r),
          (_ = t.memoizedState),
          o !== a || u !== _ || fr.current || si
            ? ("function" == typeof d &&
                (pi(t, n, d, a), (_ = t.memoizedState)),
              (d = si || Mi(t, n, o, a, u, _, l))
                ? (c ||
                    ("function" != typeof s.UNSAFE_componentWillUpdate &&
                      "function" != typeof s.componentWillUpdate) ||
                    ("function" == typeof s.componentWillUpdate &&
                      s.componentWillUpdate(a, _, l),
                    "function" == typeof s.UNSAFE_componentWillUpdate &&
                      s.UNSAFE_componentWillUpdate(a, _, l)),
            ...
            : ("function" != typeof s.componentDidUpdate ||
              ...
              "function" != typeof s.getSnapshotBeforeUpdate ||
                ...
                (t.effectTag |= 256),
              (a = !1));
      return zs(e, t, n, a, i, r);
    }
    function zs(e, t, n, a, r, i) {
      As(e, t);
      var s = 0 != (64 & t.effectTag);
      if (!a && !s) return r && kr(t, n, !1), Ks(e, t, i);
      (a = t.stateNode), (Hs.current = t);
      var o =
    ...
    var Rs,
      ...
      Us,
      Js,
      Vs = { dehydrated: null, retryTime: 0 };
    function $s(e, t, n) {
      var a,
        r = t.mode,
        i = t.pendingProps,
      ...
      if (
        ((a = 0 != (64 & t.effectTag)) ||
          (a = 0 != (2 & s) && (null === e || null !== e.memoizedState)),
        a
          ? ((o = !0), (t.effectTag &= -65))
    ...
    function Qs(e, t, n) {
      var a = t.pendingProps,
        r = a.revealOrder,
        i = a.tail;
      if ((Es(e, t, a.children, n), 0 != (2 & (a = Wi.current))))
        (a = (1 & a) | 2), (t.effectTag |= 64);
      else {
      ...
      if ((cr(Wi, a), 0 == (2 & t.mode))) t.memoizedState = null;
      else
        switch (r) {
          case "forwards":
            for (n = t.child, r = null; null !== n; )
              null !== (e = n.alternate) && null === Fi(e) && (r = n),
                (n = n.sibling);
            null === (n = r)
              ? ((r = t.child), (t.child = null))
              : ((r = n.sibling), (n.sibling = null)),
              Bs(t, !1, r, n, i, t.lastEffect);
            break;
          case "backwards":
            ...
            Bs(t, !0, n, null, i, t.lastEffect);
            break;
          case "together":
            Bs(t, !1, null, null, void 0, t.lastEffect);
            break;
          default:
            t.memoizedState = null;
        }
    ...
    function Ks(e, t, n) {
      ...
      if ((0 !== a && pu(a), t.childExpirationTime < n)) return null;
      ...
      switch (t.tag) {
        ...
        case 3:
          return (
            ...
            (null !== e && null !== e.child) || !Ss(t) || (t.effectTag |= 4),
            Is(t),
            null
          );
        case 5:
          Ai(t), (n = Ei(ji.current));
          var i = t.type;
          if (null !== e && null != t.stateNode)
            Us(e, t, i, a, n), e.ref !== t.ref && (t.effectTag |= 128);
          else {
            if (!a) {
              if (null === t.stateNode) throw Error(s(166));
              return null;
            }
            if (((e = Ei(xi.current)), Ss(t))) {
              ...
              switch (((a[Tn] = t), (a[Dn] = o), i)) {
                ...
                case "video":
                case "audio":
                  for (e = 0; e < Ke.length; e++) Gt(Ke[e], a);
                  break;
                case "source":
                  Gt("error", a);
                  break;
                ...
                case "image":
                case "link":
                  Gt("error", a), Gt("load", a);
                  break;
                case "form":
                  Gt("reset", a), Gt("submit", a);
                  break;
                case "details":
                  Gt("toggle", a);
                  break;
                case "input":
                  ke(a, o), Gt("invalid", a), sn(n, "onChange");
                  break;
                case "select":
                  ...
                  break;
                case "textarea":
                  He(a, o), Gt("invalid", a), sn(n, "onChange");
              }
                  ...
                  "children" === u
                    ? "string" == typeof l
                      ...
                      : "number" == typeof l &&
                        a.textContent !== "" + l &&
                        (e = ["children", "" + l])
                    : v.hasOwnProperty(u) && null != l && sn(n, u);
                }
              switch (i) {
                case "input":
                  Le(a), we(a, o, !0);
                ...
                case "option":
                  break;
                default:
                  "function" == typeof o.onClick && (a.onclick = on);
              }
              ...
              switch (
                ...
                case "image":
                case "link":
                  Gt("error", e), Gt("load", e), (l = a);
                  break;
                case "form":
                  Gt("reset", e), Gt("submit", e), (l = a);
                  break;
                case "details":
                  Gt("toggle", e), (l = a);
                  break;
                case "input":
                  ke(e, a), (l = Ye(e, a)), Gt("invalid", e), sn(n, "onChange");
                  break;
                case "option":
                  l = De(e, a);
                  break;
                case "select":
                  ...
                  break;
                case "textarea":
                  He(e, a), (l = xe(e, a)), Gt("invalid", e), sn(n, "onChange");
                  break;
                default:
                  l = a;
              }
                ...
                case "select":
                  (e.multiple = !!a.multiple),
                    null != (n = a.value)
                      ? Se(e, !!a.multiple, n, !1)
                      : null != a.defaultValue &&
                        Se(e, !!a.multiple, a.defaultValue, !0);
                  break;
                default:
                  "function" == typeof l.onClick && (e.onclick = on);
              }
              Ln(i, a) && (t.effectTag |= 4);
            }
          ...
          return (
            ...
            0 != (64 & t.effectTag)
              ...
              : ((n = null !== a),
                (a = !1),
                null === e
                  ? void 0 !== t.memoizedProps.fallback && Ss(t)
                ...
                n &&
                  ...
                  0 != (1 & Wi.current)
                    ? Wo === Do && (Wo = Ho)
                    : ((Wo !== Do && Wo !== Ho) || (Wo = jo),
                      0 !== Io && null !== Oo && (Ru(Oo, Ao), Iu(Oo, Io)))),
                (n || a) && (t.effectTag |= 4),
                null)
          );
        case 4:
        ...
        case 19:
          ...
          if (((i = 0 != (64 & t.effectTag)), null === (o = a.rendering))) {
            if (i) qs(a, !1);
            else if (Wo !== Do || (null !== e && 0 != (64 & e.effectTag)))
                ...
                if (null !== (e = Fi(o))) {
                  for (
                    ...
                    (o = n),
                      ...
                      (a = a.sibling);
                  return cr(Wi, (1 & Wi.current) | 2), t.child;
                }
                o = o.sibling;
              }
          } else {
            if (!i)
              if (null !== (e = Fi(o))) {
                ...
                2 * Rr() - a.renderingStartTime > a.tailExpiration &&
                  1 < n &&
                  ((t.effectTag |= 64),
                  (i = !0),
                  qs(a, !1),
          ...
          return null !== a.tail
            ? (0 === a.tailExpiration && (a.tailExpiration = Rr() + 500),
              (n = a.tail),
              (a.rendering = n),
              (a.tail = n.sibling),
              (a.lastEffect = t.lastEffect),
              (a.renderingStartTime = Rr()),
              (n.sibling = null),
              (t = Wi.current),
              cr(Wi, i ? (1 & t) | 2 : 1 & t),
              n)
    ...
    function Xs(e) {
      switch (e.tag) {
        ...
        case 3:
          if ((Oi(), dr(fr), dr(mr), 0 != (64 & (t = e.effectTag))))
            throw Error(s(285));
      ...
      (Us = function (e, t, n, a, i) {
        ...
        if (s !== a) {
          ...
          for (o in a) {
            ...
            if (
              ((l = null != s ? s[o] : void 0),
              a.hasOwnProperty(o) && d !== l && (null != d || null != l))
            )
              if ("style" === o)
                if (l) {
                  for (u in l)
        ...
        case 1:
          if (256 & t.effectTag && null !== e) {
            ...
            (t = (e = t.stateNode).getSnapshotBeforeUpdate(
              t.elementType === t.type ? n : Kr(t.type, n),
              a
            )),
              ...
              (t = i ? t.stateNode : t.stateNode.instance),
                n
                  ...
                  : (8 === a.nodeType
                    ...
                    null != a || null !== n.onclick || (n.onclick = on));
      ...
      for (var a, r, i = t, o = !1; ; ) {
        ...
        if (5 === i.tag || 6 === i.tag) {
          e: for (var u = e, l = i, d = n, c = l; ; )
            if ((uo(u, c, d), null !== c.child && 4 !== c.tag))
                ...
                case "select":
                  (t = n._wrapperState.wasMultiple),
                    ...
                    null != (e = a.value)
                      ...
                      : t !== !!a.multiple &&
                        (null != a.defaultValue
                          ? Se(n, !!a.multiple, a.defaultValue, !0)
                          : Se(n, !!a.multiple, a.multiple ? [] : "", !1));
              }
            }
          }
          return;
    ...
    function ho(e) {
      ...
      if (null !== t) {
        e.updateQueue = null;
        var n = e.stateNode;
        null === n && (n = e.stateNode = new to()),
          t.forEach(function (t) {
            var a = function (e, t) {
              var n = e.stateNode;
              null !== n && n.delete(t),
                0 == (t = 0) && (t = ru((t = au()), e, null)),
                null !== (e = su(e, t)) && uu(e);
            }.bind(null, e, t);
    ...
    function Mo(e, t, n) {
      ...
      return (
        null !== i &&
          ...
          (n.callback = function () {
            "function" != typeof a &&
              (null === Qo ? (Qo = new Set([this])) : Qo.add(this), no(e, t));
            var n = t.stack;
    ...
    function ru(e, t, n) {
      ...
      return null !== Oo && e === Ao && --e, e;
    }
    function iu(e, t) {
      if (50 < eu) throw ((eu = 0), (tu = null), Error(s(185)));
      if (null !== (e = su(e, t))) {
        var n = Ir();
        1073741823 === t
          ? (Po & bo) !== vo && (Po & (wo | To)) === vo
            ? lu(e)
            : (uu(e), Po === vo && Gr())
          : uu(e),
          (4 & Po) === vo ||
    ...
    function su(e, t) {
      ...
      return (
        null !== r && (Oo === r && (pu(t), Wo === jo && Ru(r, Ao)), Iu(r, t)), r
      );
    }
    function ou(e) {
    ...
    function uu(e) {
      if (0 !== e.lastExpiredTime)
        (e.callbackExpirationTime = 1073741823),
          ...
          (e.callbackNode = $r(lu.bind(null, e)));
      else {
        var t = ou(e),
          n = e.callbackNode;
        if (0 === t)
            ...
            (t =
              1073741823 === t
                ...
                : Vr(
                    ...
                    function e(t, n) {
                      nu = 0;
                      if (n) return (n = au()), Uu(t, n), uu(t), null;
                      var a = ou(t);
                      if (0 !== a) {
                        if (((n = t.callbackNode), (Po & (wo | To)) !== vo))
                          throw Error(s(327));
                        if (
                          (bu(),
                          (t === Oo && a === Ao) || _u(t, a),
                          ...
                          if ((ti(), (Po = r), (Yo.current = i), Wo === So))
                            throw ((n = Fo), _u(t, a), Ru(t, a), uu(t), n);
                          if (null === Co)
                            switch (
                              ((i = t.finishedWork = t.current.alternate),
                              (t.finishedExpirationTime = a),
                              (r = Wo),
                              (Oo = null),
                              r)
                            ) {
                              ...
                              case Ho:
                                if (
                                  ...
                                  a === r && (t.nextKnownPendingLevel = Yu(i)),
                                  1073741823 === zo &&
                                    10 < (i = Jo + Vo - Rr()))
                                ) {
                                  if (Uo) {
                                    ...
                                    if (0 === o || o >= a) {
                                      (t.lastPingedTime = a), _u(t, a);
                                      break;
                                    }
                                  }
                                  if (0 !== (o = ou(t)) && o !== a) break;
                                  if (0 !== r && r !== a) {
                                    t.lastPingedTime = r;
                                    break;
                                  }
                                  t.timeoutHandle = Yn(ku.bind(null, t), i);
                                  break;
                                }
                                ku(t);
                                break;
                              case jo:
                                if (
                                  ...
                                  a === r && (t.nextKnownPendingLevel = Yu(i)),
                                  Uo &&
                                    (0 === (i = t.lastPingedTime) || i >= a))
                                ) {
                                  (t.lastPingedTime = a), _u(t, a);
                                  break;
                                }
                                if (0 !== (i = ou(t)) && i !== a) break;
                                if (0 !== r && r !== a) {
                                  t.lastPingedTime = r;
                                  break;
                                }
                                if (
                                  ...
                                  t.timeoutHandle = Yn(ku.bind(null, t), r);
                                  break;
                                }
                                ku(t);
                                break;
    ...
    function lu(e) {
      var t = e.lastExpiredTime;
      if (((t = 0 !== t ? t : 1073741823), (Po & (wo | To)) !== vo))
        throw Error(s(327));
      if ((bu(), (e === Oo && t === Ao) || _u(e, t), null !== Co)) {
        var n = Po;
        Po |= wo;
        for (var a = fu(); ; )
          try {
        ...
        if ((ti(), (Po = n), (Yo.current = a), Wo === So))
          throw ((n = Fo), _u(e, t), Ru(e, t), uu(e), n);
        if (null !== Co) throw Error(s(261));
    ...
    function _u(e, t) {
      ...
      if ((-1 !== n && ((e.timeoutHandle = -1), kn(n)), null !== Co))
        for (n = Co.return; null !== n; ) {
          ...
          switch (a.tag) {
            case 1:
              null != (a = a.type.childContextTypes) && Mr();
              break;
            case 3:
              Oi(), dr(fr), dr(mr);
              break;
            ...
            if (
              ...
              do {
                ...
                if (_) {
                  ...
                  if (0 == (2 & c.mode)) {
                    if (
                      ((c.effectTag |= 64), (s.effectTag &= -2981), 1 === s.tag)
                    )
              ...
              o = Error(
                (he(s.type) || "A React component") +
                  " suspended while rendering, but no fallback UI was specified.\n\nAdd a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display." +
                  pe(s)
              );
            }
            Wo !== Eo && (Wo = xo), (o = eo(o, s)), (c = i);
            do {
              switch (c.tag) {
                case 3:
                  (u = o),
    ...
    function fu() {
      var e = Yo.current;
      return (Yo.current = ys), null === e ? ys : e;
    }
    function hu(e, t) {
      e < zo && 2 < e && (zo = e),
        null !== t && e < No && 2 < e && ((No = e), (Ro = t));
    }
    function pu(e) {
      e > Io && (Io = e);
    }
    function yu() {
      for (; null !== Co; ) Co = Lu(Co);
    }
    function Mu() {
      for (; null !== Co && !Cr(); ) Co = Lu(Co);
    }
    function Lu(e) {
      var t = Lo(e.alternate, e, Ao);
      return (
    ...
    function gu(e) {
      ...
      do {
        ...
        if (((e = Co.return), 0 == (2048 & Co.effectTag))) {
          if (((t = Zs(t, Co, Ao)), 1 === Ao || 1 !== Co.childExpirationTime)) {
            for (var n = 0, a = Co.child; null !== a; ) {
          ...
          if (null !== (t = Xs(Co))) return (t.effectTag &= 2047), t;
          null !== e &&
      ...
      return (
        Jr(
          ...
          function (e, t) {
            ...
            if ((Po & (wo | To)) !== vo) throw Error(s(327));
            ...
            if (
                  ...
                  for (o = e, u = t; null !== $o; ) {
                    ...
                    switch (1038 & g) {
                      case 2:
                        ...
                        break;
                      case 6:
                        _o($o), ($o.effectTag &= -3), fo($o.alternate, $o);
                        break;
                      case 1024:
                        $o.effectTag &= -1025;
                        break;
                      case 1028:
                        ($o.effectTag &= -1025), fo($o.alternate, $o);
                        break;
                      case 4:
                        fo($o.alternate, $o);
                        break;
              ...
              if (
                  ...
                  "selectionStart" in g
                    ...
                    : (k =
                      ...
                      d &&
                        ...
                        k.removeAllRanges(),
                        o > u
                          ? (k.addRange(Y), k.extend(c.node, c.offset))
                          : (Y.setEnd(c.node, c.offset), k.addRange(Y))))),
                  (Y = []);
                ...
                for (
                  ...
                  ((k = Y[g]).element.scrollLeft = k.left),
                    (k.element.scrollTop = k.top);
              }
              ($t = !!yn), (Mn = yn = null), (e.current = n), ($o = r);
              do {
                try {
                  for (g = e; null !== $o; ) {
                    var v = $o.effectTag;
                    if ((36 & v && oo(g, $o.alternate, $o), 128 & v)) {
                      Y = void 0;
                      var b = $o.ref;
                      if (null !== b) {
                        var w = $o.stateNode;
                        ...
                        "function" == typeof b ? b(Y) : (b.current = Y);
                      }
                    }
                    $o = $o.nextEffect;
                  }
            ...
            if (
              ...
              1073741823 === t
                ? e === tu
                  ...
                  : ((eu = 0), (tu = e))
                : (eu = 0),
              "function" == typeof xu && xu(n.stateNode, a),
              uu(e),
              Go)
            )
              throw ((Go = !1), (e = Bo), (Bo = null), e);
            return (Po & bo) !== vo ? null : (Gr(), null);
          }.bind(null, e, t)
        ),
        null
      );
    ...
    function bu() {
      if (90 !== Zo) {
        var e = 97 < Zo ? 97 : Zo;
        return (Zo = 90), Jr(e, wu);
      }
    }
    function wu() {
      if (null === qo) return !1;
      var e = qo;
      if (((qo = null), (Po & (wo | To)) !== vo)) throw Error(s(331));
      var t = Po;
    ...
    function Tu(e, t, n) {
      di(e, (t = yo(e, (t = eo(n, t)), 1073741823))),
        null !== (e = su(e, 1073741823)) && uu(e);
    }
    function Du(e, t) {
      if (3 === e.tag) Tu(e, e, t);
      else
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              di(n, (e = Mo(n, (e = eo(t, e)), 1073741823))),
                null !== (n = su(n, 1073741823)) && uu(n);
              break;
            }
          }
          n = n.return;
    ...
    function Su(e, t, n) {
      ...
      null !== a && a.delete(t),
        Oo === e && Ao === n
          ? Wo === jo || (Wo === Ho && 1073741823 === zo && Rr() - Jo < Vo)
            ? _u(e, Ao)
            : (Uo = !0)
          : Nu(e, n) &&
    ...
    Lo = function (e, t, n) {
      ...
      if (null !== e) {
        ...
        if (e.memoizedProps !== r || fr.current) js = !0;
        else {
          if (a < n) {
            switch (((js = !1), t.tag)) {
              case 3:
              ...
              case 13:
                if (null !== t.memoizedState)
                  return 0 !== (a = t.child.childExpirationTime) && a >= n
                    ? $s(e, t, n)
                    : (cr(Wi, 1 & Wi.current),
                      null !== (t = Ks(e, t, n)) ? t.sibling : null);
                cr(Wi, 1 & Wi.current);
                break;
              case 19:
                if (
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        case 2:
          if (
            ...
            "function" == typeof o && pi(t, a, o, e),
              (r.updater = yi),
              (t.stateNode = r),
              (r._reactInternalFiber = t),
              Yi(t, a, e, n),
              (t = zs(null, t, a, !0, i, n));
          } else (t.tag = 0), Es(null, t, r, n), (t = t.child);
          return t;
        case 16:
          e: {
            if (
        ...
        case 0:
          return (
            (a = t.type),
            (r = t.pendingProps),
            Ws(e, t, a, (r = t.elementType === a ? r : Kr(a, r)), n)
          );
        case 1:
          return (
            (a = t.type),
            (r = t.pendingProps),
            Fs(e, t, a, (r = t.elementType === a ? r : Kr(a, r)), n)
          );
        case 3:
          if ((Ns(t), (a = t.updateQueue), null === e || null === a))
            throw Error(s(282));
          if (
            ((a = t.pendingProps),
            ...
            if (
              ((r = t.stateNode.hydrate) &&
                ((ks = vn(t.stateNode.containerInfo.firstChild)),
                (Ys = t),
                (r = vs = !0)),
              r)
            )
              for (n = Di(t, null, a, n), t.child = n; n; )
        ...
        case 4:
          return (
            Pi(t, t.stateNode.containerInfo),
            (a = t.pendingProps),
            null === e ? (t.child = Ti(t, null, a, n)) : Es(e, t, a, n),
            t.child
          );
        case 11:
          return (
            (a = t.type),
            (r = t.pendingProps),
            Ps(e, t, a, (r = t.elementType === a ? r : Kr(a, r)), n)
          );
        case 7:
        ...
        case 10:
          e: {
            ...
            if ((cr(qr, u._currentValue), (u._currentValue = i), null !== o))
              if (
                ((u = o.value),
                0 ===
                  (i = za(u, i)
        ...
        case 9:
          return (
            ...
            ri(t, n),
            (a = a((r = ii(r, i.unstable_observedBits)))),
            (t.effectTag |= 1),
            Es(e, t, a, n),
            t.child
          );
        case 14:
          return (
            (i = Kr((r = t.type), t.pendingProps)),
            Os(e, t, r, (i = Kr(r.type, i)), a, n)
          );
        case 15:
          return Cs(e, t, t.type, t.pendingProps, a, n);
        case 17:
          return (
            (a = t.type),
            (r = t.pendingProps),
    ...
    function Cu(e, t, n, a, r, i) {
      var o = 2;
      if (((a = e), "function" == typeof e)) Pu(e) && (o = 1);
      else if ("string" == typeof e) o = 5;
      else
        e: switch (e) {
          case te:
            return Au(n.children, r, i, t);
          case se:
            (o = 8), (r |= 7);
            break;
          case ne:
          ...
          case ae:
            return (
              ((e = Eu(12, n, t, 8 | r)).elementType = ae),
              (e.type = ae),
              (e.expirationTime = i),
              e
            );
    ...
    function Au(e, t, n, a) {
      return ((e = Eu(7, e, a, t)).expirationTime = n), e;
    }
    function Wu(e, t, n) {
    ...
    function Bu(e, t, n) {
      var a = new zu(e, t, (n = null != n && !0 === n.hydrate)),
        r = Eu(3, null, null, 2 === t ? 7 : 1 === t ? 3 : 0);
      (a.current = r),
        (r.stateNode = a),
        oi(r),
        (e[Sn] = a.current),
    ...
    (Bu.prototype.render = function (e) {
      ...
      (pt = function (e) {
        13 === e.tag && (iu(e, 3), Gu(e, 3));
      }),
      (yt = function (e) {
        if (13 === e.tag) {
          var t = au();
          iu(e, (t = ru(t, e, null))), Gu(e, t);
        }
      }),
      (D = function (e, t, n) {
        switch (t) {
      ...
      (O = function (e, t, n, a, r) {
        ...
        Po |= 4;
        try {
          return Jr(98, e.bind(null, t, n, a, r));
        } finally {
          (Po = i) === vo && Gr();
        }
      }),
    ...
    !(function (e) {
      ...
      (t.flushSync = function (e, t) {
        if ((Po & (wo | To)) !== vo) throw Error(s(187));
        var n = Po;
        Po |= 1;
        try {
          return Jr(99, e.bind(null, t));
        } finally {
          (Po = n), Gr();
        }
      }),
  ...
  function (e, t, n) {
    ...
    var v = (k.prototype = new Y());
    (v.constructor = k), a(v, g.prototype), (v.isPureReactComponent = !0);
    var b = { current: null },
    ...
    function D(e, t, n) {
      ...
      if (null != t)
        ...
        t))
          w.call(t, a) && !T.hasOwnProperty(a) && (r[a] = t[a]);
      ...
      if (e && e.defaultProps)
        for (a in (u = e.defaultProps)) void 0 === r[a] && (r[a] = u[a]);
      return {
        $$typeof: i,
        type: e,
        key: s,
      ...
      return null == e
        ...
        : (function e(t, n, a, r) {
            ...
            if (((u = 0), (n = "" === n ? "." : n + ":"), Array.isArray(t)))
              ...
              for (t = d.call(t), l = 0; !(o = t.next()).done; )
                u += e((o = o.value), (d = n + O(o, l++)), a, r);
            else if ("object" === o)
              throw (
                ((a = "" + t),
                Error(
    ...
    (t.Children = {
      map: function (e, t, n) {
        if (null == e) return e;
        var a = [];
        return W(e, a, null, t, n), a;
      },
      forEach: function (e, t, n) {
        if (null == e) return e;
        P(e, C, (t = j(null, null, t, n))), E(t);
      },
      count: function (e) {
        return P(
          e,
  ...
  function (e, t, n) {
    ...
    if ("undefined" == typeof window || "function" != typeof MessageChannel) {
      ...
      (v.port1.onmessage = function () {
        if (null !== L) {
          ...
          k = e + Y;
          try {
            L(!0, e) ? b.postMessage(null) : ((M = !1), (L = null));
          } catch (e) {
    ...
    var x = [],
      ...
      A = !1;
    function W(e) {
      for (var t = T(H); null !== t; ) {
        if (null === t.callback) D(H);
        else {
          if (!(t.startTime <= e)) break;
          D(H), (t.sortIndex = t.expirationTime), w(x, t);
        }
        t = T(H);
      }
    }
    ...
    function z(e, n) {
      ...
      try {
        for (
          W(n), E = T(x);
          null !== E && (!(E.expirationTime > n) || (e && !s()));

        ) {
          var o = E.callback;
          if (null !== o) {
            (E.callback = null), (P = E.priorityLevel);
            var u = o(E.expirationTime <= n);
            (n = t.unstable_now()),
              "function" == typeof u ? (E.callback = u) : E === T(x) && D(x),
              W(n);
          } else D(x);
          E = T(x);
        }
      ...
      (t.unstable_scheduleCallback = function (e, n, s) {
        ...
        if ("object" == typeof s && null !== s) {
          ...
          (u = "number" == typeof u && 0 < u ? o + u : o),
            (s = "number" == typeof s.timeout ? s.timeout : N(e));
        } else (s = N(e)), (u = o);
        return (
          (e = {
            id: j++,
          ...
          u > o
            ? ((e.sortIndex = u),
              w(H, e),
              null === T(x) && e === T(H) && (A ? i() : (A = !0), r(F, u - o)))
            : ((e.sortIndex = s), w(x, e), C || O || ((C = !0), a(z))),
          e
        );
      }),
  ...
  function (e, t) {
    ...
    function _() {
      d &&
        u &&
        ((d = !1), u.length ? (l = u.concat(l)) : (c = -1), l.length && m());
    }
    function m() {
      if (!d) {
        var e = o(_);
